...
/**
 * This Instant Command closes the cylinders which are located in the sides of the caliber
 */
public class ReleaseCube extends InstantCommand {
    ...
    //In the Initialize method- runs the method caliberRelease of the caliber one time
