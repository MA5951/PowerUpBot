...
public class IntakeSubSystem extends Subsystem {
	...
	public IntakeSubSystem() {
		...
		LeftSolenoid = new DoubleSolenoid(RobotMap.PCM, RobotMap.INTAKE_PISTON_LEFT_REVERSE,
		RobotMap.INTAKE_PISTON_LEFT_FORWORD);
		RightSolenoid = new DoubleSolenoid(RobotMap.PCM, RobotMap.INTAKE_PISTON_RIGHT_FORWORD,
